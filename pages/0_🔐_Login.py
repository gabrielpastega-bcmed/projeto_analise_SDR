...
# Page configuration
st.set_page_config(
    page_title="Login - SDR Analytics", page_icon="🔐", layout="centered", initial_sidebar_state="collapsed"
)
...
if AuthManager.is_authenticated():
    ...
    with st.form("login_form", clear_on_submit=False):
        username = st.text_input(
            "👤 Usuário", placeholder="Digite seu usuário", help="Nome de usuário fornecido pelo administrador"
        )
