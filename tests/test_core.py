...
def sample_chat():
    return Chat(
        ...
        agent={"id": "a1", "name": "Agent Smith", "email": "agent@bcmed.com.br"},
        status="closed",
        messages=[
            Message(
                id="m1",
            ...
            Message(
                ...
                type="public",
                chatId="test-chat",
                sentBy=MessageSender(id="a1", type="agent", email="agent@bcmed.com.br"),
            ),
        ],
    )
